<#
.SYNOPSIS
    Detects if Fusion360 is up to date for use with Intune. 
.DESCRIPTION
    This script checks the locally installed version of Fusion 360 vs the most up to date version online then uses exit code 0 for success and exit 1 for failure used for Intune detection. 
.NOTES
    Author: Austen Ewald
    Version: 1.2
